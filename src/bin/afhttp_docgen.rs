...
#[derive(Parser)]
#[command(name = "afhttp-docgen")]
#[command(about = "Generate Markdown reference docs from afhttp's clap definitions")]
struct Args {
...
fn render_reference_markdown() -> String {
    let raw = clap_markdown::help_markdown::<Cli>();
