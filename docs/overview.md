...
- [CLI](cli.md) — Generated CLI guide and flag reference from `src/cli.rs`
- [Protocol Reference](reference.md) — full field specification
- [Testing Strategy](testing.md) — layered tests, coverage gate, regression policy
- [Design](design.md) — architecture and principles
